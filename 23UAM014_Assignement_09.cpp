...
cout << "3) Multiplication : " << intCalc.multiply() << endl;
    cout << "4) Division : " << intCalc.divide() << endl;
    cout<< "\nFloat operations"<<endl;
    Calculator<float> floatCalc(3.5f, 2.0f);
cout << "1) Addition : " << floatCalc.add() << endl;
    cout << "2) Subtraction : " << floatCalc.subtract() << endl;
    cout << "3) Multiplication : " << floatCalc.multiply() << endl;
    cout << "4) Division : " << floatCalc.divide() << endl;
